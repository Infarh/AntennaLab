...
namespace Antennas
{
    public static class BeamPatternExtensions
    {
        ...
        public static double GetDirectivity([NotNull] this Func<double, Complex> Pattern)
        {
        ...
        public static Task<double> GetDirectivityAsync([NotNull] this Func<double, Complex> F) => Task.Factory.StartNew(F.GetDirectivity);

        public static double GetDirectivityBuffered([NotNull] this Func<double, Complex> F) => 2 / FuncExtensions.GetIntegralValue_Adaptive(th => F(th).Power * Math.Cos(th), -Consts.pi, Consts.pi);

        public static Task<double> GetDirectivityBufferedAsync([NotNull] this Func<double, Complex> F) => Task.Factory.StartNew(F.GetDirectivityBuffered);
    }
}

...
public class AntennaArray : Antenna, IList<AntennaItem>
{
    ...
    public static AntennaArray CreateLinearArray(IEnumerable<Antenna> antennas, double d) => new LinearAntennaArray(antennas, d);
    ...
    public void AddRange(IEnumerable<AntennaItem> collection)
    {
    ...
    private static BinaryExpression Add(Expression a, Expression b) => Expression.Add(a, b);
